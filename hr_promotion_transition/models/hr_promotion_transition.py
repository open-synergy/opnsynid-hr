...
class HrPromotionTransition(models.Model):
    ...
    def _default_type_id(self):
        return self.env.ref("hr_promotion_transition." "career_transition_promotion").id

    @api.model
    def search(self, args, offset=0, limit=None, order=None, count=False):
        type_id = (
            self.env.ref(
                "hr_promotion_transition." "career_transition_promotion", False
            )
            and self.env.ref("hr_promotion_transition." "career_transition_promotion")
