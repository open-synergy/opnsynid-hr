...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-ssi_hr_employee_identification_from_work_address',
        'odoo14-addon-ssi_hr_employee_language_from_work_address',
        'odoo14-addon-ssi_hr_employee_personal_from_work_address',
