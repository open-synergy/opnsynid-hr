...
class TestTimesheetViewer(BaseCase):
    def test_timesheet_viewer_supervisor(self):
        ...
        self.assertEqual(
            timesheet_1.sudo(self.user_2).name,
            "Timesheet 1")
        self.assertEqual(
            timesheet_2.sudo(self.user_2).name,
            "Timesheet 2")
    ...
    def test_timesheet_viewer_department(self):
        ...
        self.assertEqual(
            timesheet_5.sudo(self.user_4).name,
            "Timesheet 5")
        self.assertEqual(
            timesheet_6.sudo(self.user_4).name,
            "Timesheet 6")
        with self.assertRaises(except_orm):
    ...
    def test_timesheet_viewer_company(self):
        ...
        self.assertEqual(
            timesheet_8.sudo(self.user_8).name,
            "Timesheet 8")
        self.assertEqual(
            timesheet_9.sudo(self.user_8).name,
            "Timesheet 9")
        with self.assertRaises(except_orm):
