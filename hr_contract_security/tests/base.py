...
class BaseCase(TransactionCase):
    def setUp(self, *args, **kwargs):
        ...
        # Employee 1 With Contract Security User Groups
                ...
                "groups_id": [
                    (
                        ...
                        [
                            ...
                            self.env.ref("hr_contract_security.group_contract_user").id,
                        ],
                    )
                ],
                ...
                "groups_id": [
                    (
                        ...
                        [
                            self.grp_employee.id,
                            self.env.ref(
                                "hr_contract_security.group_contract_supervisor"
                            ).id,
                            self.env.ref(
                                "hr_contract_security.group_contract_viewer_supervisor"
                            ).id,
                        ],
                    )
                ],
                ...
                "groups_id": [
                    (
                        ...
                        [
                            self.grp_employee.id,
                            self.env.ref(
                                "hr_contract_security.group_contract_department"
                            ).id,
                            self.env.ref(
                                "hr_contract_security.group_contract_viewer_department"
                            ).id,
                        ],
                    )
                ],
                ...
                "groups_id": [
                    (
                        ...
                        [
                            self.grp_employee.id,
                            self.env.ref(
                                "hr_contract_security.group_contract_company"
                            ).id,
                            self.env.ref(
                                "hr_contract_security.group_contract_viewer_department"
                            ).id,
