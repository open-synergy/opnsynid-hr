    ...
    def setUp(self, *args, **kwargs):
        ...
        self.user_2 = self.obj_user.sudo().create({
            ...
            "groups_id": [(6, 0, [
                self.grp_employee.id,
                self.env.ref(
                    "hr_contract_security.group_contract_supervisor").id,
                self.env.ref(
        ...
        self.user_4 = self.obj_user.sudo().create({
            ...
            "groups_id": [(6, 0, [
                self.grp_employee.id,
                self.env.ref(
                    "hr_contract_security.group_contract_department").id,
                self.env.ref(
        ...
        self.user_8 = self.obj_user.sudo().create({
            ...
            "groups_id": [(6, 0, [
                self.grp_employee.id,
                self.env.ref("hr_contract_security.group_contract_company").id,
                self.env.ref(
                    "hr_contract_security.group_contract_viewer_department"
                ).id]
            )],
