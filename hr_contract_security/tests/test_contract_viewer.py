...
class TestContractViewer(BaseCase):
    def test_contract_viewer_supervisor(self):
        ...
        self.assertEqual(
            contract_1.sudo(self.user_2).name,
            "Contract 1")
        self.assertEqual(
            contract_2.sudo(self.user_2).name,
            "Contract 2")
    ...
    def test_contract_viewer_department(self):
        ...
        self.assertEqual(
            contract_5.sudo(self.user_4).name,
            "Contract 5")
        self.assertEqual(
            contract_6.sudo(self.user_4).name,
            "Contract 6")
        with self.assertRaises(except_orm):
    ...
    def test_contract_viewer_company(self):
        ...
        self.assertEqual(
            contract_8.sudo(self.user_8).name,
            "Contract 8")
        self.assertEqual(
            contract_9.sudo(self.user_8).name,
            "Contract 9")
        with self.assertRaises(except_orm):
