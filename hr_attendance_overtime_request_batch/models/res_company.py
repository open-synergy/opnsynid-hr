...
class ResCompany(models.Model):
    ...
    overtime_request_batch_confirm_grp_ids = fields.Many2many(
        string="Allowed To Confirm Overtime Request Batch",
    ...
    overtime_request_batch_valid_grp_ids = fields.Many2many(
        string="Allowed To Validate Overtime Request Batch",
        comodel_name="res.groups",
    ...
    overtime_request_batch_cancel_grp_ids = fields.Many2many(
        string="Allowed To Cancel Overtime Request Batch",
        comodel_name="res.groups",
    ...
    overtime_request_batch_restart_grp_ids = fields.Many2many(
        string="Allowed To Restart Overtime Request Batch",
        comodel_name="res.groups",
    ...
    overtime_request_batch_generate_grp_ids = fields.Many2many(
        string="Allowed To Generate Overtime Request Batch",
        comodel_name="res.groups",
    ...
    @api.multi
    def _get_overtime_batch_button_policy(self, policy_field):
        self.ensure_one()
        result = False
        button_group_ids = []
        user = self.env.user
