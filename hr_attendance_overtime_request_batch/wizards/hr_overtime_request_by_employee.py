...
class HrOvertimeRequestByEmployee(models.TransientModel):
    ...
    def fields_view_get(
        ...
        manager_id =\
            self._context.get('manager_id', False)
        if department_id:
    ...
    def _prepare_data(self, request_batch_id,
        ...
        manager_id =\
            batch.manager_id.id or False
        department_id =\
            batch.department_id.id or False
    ...
    def action_generate(self):
        self.ensure_one()
        obj_overtime_request =\
            self.env["hr.overtime_request"]
        obj_overtime_request_batch =\
            self.env["hr.overtime_request_batch"]
        ...
        if active_id:
            ...
            batch =\
                obj_overtime_request_batch.search(criteria)
