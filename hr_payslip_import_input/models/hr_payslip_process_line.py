...
class HrPayslipRunProcessInputLine(models.Model):
    ...
    name = fields.Many2one(
        string="Filename", comodel_name="hr.payslip_run_imported_input_file"
    )
    employee_code = fields.Char(string="Employee Code")
    input_code = fields.Char(string="Code")
    amount = fields.Float(string="Amount")
    input_id = fields.Many2one(string="Input", comodel_name="hr.payslip.input")
